...
(function dartProgram() {
  ...
  var A = {JS_CONST: function JS_CONST() {
    ...
    Object_hash(object1, object2, object3, object4, object5, object6, object7) {
      ...
      if (B.C_SentinelValue === object7) {
        t1 = A.Primitives_objectHashCode(object1);
        object2 = B.JSString_methods.get$hashCode(object2);
        object3 = B.JSBool_methods.get$hashCode(object3);
        object4 = B.JSInt_methods.get$hashCode(object4);
        object5 = B.JSNumber_methods.get$hashCode(object5);
    ...
    CheckedFromJsonException: function CheckedFromJsonException(t0, t1, t2) {
      this.key = t0;
      this.message = t1;
      this._className = t2;
    },
    main() {
      var port = A._Cell$named("port"),
        t1 = type$.nullable_EventTarget._as(self.self),
        t2 = type$.nullable_void_Function_MessageEvent._as(new A.main_closure(port));
    ...
    Wrapper: function Wrapper(t0, t1) {
      this.base = t0;
      this._base = t1;
    },
    _$DataFromJson(json) {
      ...
      switch (json.$index(0, _s11_)) {
        case "v1":
          t1 = A._asString(json.$index(0, "yo"));
          t2 = A._asBool(json.$index(0, "bla"));
          t3 = A._asInt(json.$index(0, "intejer"));
          t4 = A._asNum(json.$index(0, "doublee"));
          t5 = A.DateTime_parse(A._asString(json.$index(0, "date")));
          t6 = type$.Map_String_dynamic._as(json.$index(0, "objact")).cast$2$0(0, type$.String, type$.dynamic);
          t7 = t6._source;
          t6 = t6.$ti._eval$1("4?");
          t8 = A._asString(t6._as(t7.$index(0, "foo")));
          t7 = A._asInt(t6._as(t7.$index(0, "bar")));
          A._asStringQ(json.$index(0, _s11_));
          return new A._$_Data1(t1, t2, t3, t4, t5, new A.Objact(t8, t7));
        case "v3":
          t1 = A._asString(json.$index(0, "ya"));
          t2 = A._asBool(json.$index(0, "blo"));
          t3 = A._asInt(json.$index(0, "inteher"));
          t4 = A._asNum(json.$index(0, "doubli"));
          t5 = A.DateTime_parse(A._asString(json.$index(0, "datee")));
          A._asStringQ(json.$index(0, _s11_));
          return new A._$_Data2(t1, t2, t3, t4, t5);
        default:
          throw A.wrapException(new A.CheckedFromJsonException(_s11_, 'Invalid union type "' + A.S(json.$index(0, _s11_)) + '"!', "Data"));
      }
    },
    Objact: function Objact(t0, t1) {
      this.foo = t0;
      this.bar = t1;
    },
    Data: function Data() {
    ...
    _$_Data1: function _$_Data1(t0, t1, t2, t3, t4, t5) {
      var _ = this;
      _.yo = t0;
      _.bla = t1;
      _.intejer = t2;
    ...
    _$_Data2: function _$_Data2(t0, t1, t2, t3, t4) {
      var _ = this;
      _.ya = t0;
      _.blo = t1;
      _.inteher = t2;
  ...
  A.MapMixin.prototype = {
    cast$2$0(_, RK, RV) {
      ...
      return new A.CastMap(this, t1._eval$1("@<MapMixin.K>")._bind$1(t1._eval$1("MapMixin.V"))._bind$1(RK)._bind$1(RV)._eval$1("CastMap<1,2,3,4>"));
    },
    forEach$1(_, action) {
      var t2, key, t3,
  ...
  A.DelegatingMap.prototype = {
    $index(_, key) {
      var t1 = this._base;
      return t1.$ti._eval$1("4?")._as(t1._source.$index(0, key));
    },
    cast$2$0(_, K2, V2) {
      return this._base.cast$2$0(0, K2, V2);
    },
    containsKey$1(key) {
      return this._base._source.containsKey$1(key);
    },
    get$length(_) {
      var t1 = this._base._source;
      return t1.get$length(t1);
    },
    toString$0(_) {
  ...
  A.main_closure.prototype = {
    call$1(e) {
      ...
      t1._as(e);
      if (type$.Map_dynamic_dynamic._as(new A._AcceptStructuredCloneDart2Js([], []).convertNativeToDart_AcceptStructuredClone$2$mustCopy(e.data, true)).containsKey$1("foo")) {
        t2 = this.port;
        t3 = t2._value = J.get$first$ax(e.ports);
        if (t3 === t2)
          A.throwExpression(new A.LateError("Local '" + t2._name + "' has not been initialized."));
        type$.nullable_EventTarget._as(t3);
        t2 = type$.nullable_void_Function_MessageEvent._as(new A.main__closure());
        type$.nullable_void_Function._as(null);
        A._EventStreamSubscription$(t3, "message", t2, false, t1);
      }
    },
    $signature: 6
  };
  A.main__closure.prototype = {
    call$1(e) {
      var t1 = type$.Map_dynamic_dynamic._as(new A._AcceptStructuredCloneDart2Js([], []).convertNativeToDart_AcceptStructuredClone$2$mustCopy(type$.MessageEvent._as(e).data, true));
      A.printString(A._$DataFromJson(new A.Wrapper(t1, t1.cast$2$0(0, type$.String, type$.dynamic))).toString$0(0));
    },
    $signature: 6
  };
  A.Wrapper.prototype = {
    $index(_, key) {
      var value = this.base.$index(0, key);
      if (type$.Map_dynamic_dynamic._is(value))
        return new A.Wrapper(value, value.cast$2$0(0, type$.String, type$.dynamic));
      return value;
    }
  };
  A.Objact.prototype = {
  ...
  A.Data.prototype = {};
  A._$Data.prototype = {};
  A._$_Data1.prototype = {
    toString$0(_) {
      var _this = this;
      return "Data.v1(yo: " + _this.yo + ", bla: " + _this.bla + ", intejer: " + _this.intejer + ", doublee: " + A.S(_this.doublee) + ", date: " + _this.date.toString$0(0) + ", objact: " + _this.objact.toString$0(0) + ")";
    },
    $eq(_, other) {
      ...
      if (_this !== other)
        if (J.get$runtimeType$(other) === A.getRuntimeType(_this))
          if (other instanceof A._$_Data1) {
            t1 = other.yo === _this.yo;
            if (t1 || t1) {
              t1 = other.bla === _this.bla;
              if (t1 || t1) {
                t1 = other.intejer === _this.intejer;
                if (t1 || t1) {
                  t1 = other.doublee === _this.doublee;
                  if (t1 || t1) {
                    t1 = other.date;
                    t2 = _this.date;
                    if (t1 === t2 || t1.$eq(0, t2)) {
                      t1 = other.objact === _this.objact;
                      t1 = t1 || t1;
                    } else
                      t1 = false;
                  } else
    ...
    get$hashCode(_) {
      var _this = this;
      return A.Object_hash(A.getRuntimeType(_this), _this.yo, _this.bla, _this.intejer, _this.doublee, _this.date, _this.objact);
    }
  };
  A._$_Data2.prototype = {
    toString$0(_) {
      var _this = this;
      return "Data.v3(ya: " + _this.ya + ", blo: " + _this.blo + ", inteher: " + _this.inteher + ", doubli: " + A.S(_this.doubli) + ", datee: " + _this.datee.toString$0(0) + ")";
    },
    $eq(_, other) {
      var t1, t2, _this = this;
      if (other == null)
      ...
      if (_this !== other)
        if (J.get$runtimeType$(other) === A.getRuntimeType(_this))
          if (other instanceof A._$_Data2) {
            t1 = other.ya === _this.ya;
            if (t1 || t1) {
              t1 = other.blo === _this.blo;
              if (t1 || t1) {
                t1 = other.inteher === _this.inteher;
                if (t1 || t1) {
                  t1 = other.doubli === _this.doubli;
                  if (t1 || t1) {
                    t1 = other.datee;
                    t2 = _this.datee;
                    t1 = t1 === t2 || t1.$eq(0, t2);
    ...
    get$hashCode(_) {
      var _this = this;
      return A.Object_hash(A.getRuntimeType(_this), _this.ya, _this.blo, _this.inteher, _this.doubli, _this.datee, B.C_SentinelValue);
    }
  };
  ...
  (function inheritance() {
    ...
    _inheritMany(A.Object, [A.JS_CONST, J.Interceptor, J.ArrayIterator, A.Iterable, A.CastIterator, A.MapMixin, A.Closure, A.Error, A.SentinelValue, A.ListIterator, A.FixedLengthListMixin, A.TypeErrorDecoder, A.NullThrownFromJavaScriptException, A._StackTrace, A.LinkedHashMapCell, A.LinkedHashMapKeyIterator, A.JSSyntaxRegExp, A._MatchImplementation, A._Cell, A.Rti, A._FunctionParameters, A._Type, A._TimerImpl, A.AsyncError, A._Completer, A._FutureListener, A._Future, A._AsyncCallbackEntry, A.Stream, A.StreamSubscription, A._Zone, A.ListMixin, A.DateTime, A.StackOverflowError, A._Exception, A.FormatException, A.Null, A._StringStackTrace, A.StringBuffer, A.EventStreamProvider, A._AcceptStructuredClone, A.NullRejectionException, A.DelegatingMap, A.CheckedFromJsonException, A.Objact, A._Data_Object__$Data, A._$Data, A._$_Data1, A._$_Data2]);
    ...
    _inherit(A.MessagePort, A.EventTarget);
    ...
    _inherit(A.Wrapper, A.DelegatingMap);
  ...
  var init = {
    ...
    mangledNames: {},
    types: ["~()", "~(~())", "Null(@)", "Null()", "int(String?)", "~(@)", "~(MessageEvent)", "@(@)", "@(@,String)", "@(String)", "Null(~())", "Null(Object,StackTrace)", "_Future<@>(@)", "~(Object?,Object?)", "~(Event)", "@(@,@)"],
    interceptorsByTag: null,
    leafTags: null,
    arrayRti: Symbol("$ti")
  };
  A._Universe_addRules(init.typeUniverse, JSON.parse('{"PlainJavaScriptObject":"LegacyJavaScriptObject","UnknownJavaScriptObject":"LegacyJavaScriptObject","JavaScriptFunction":"LegacyJavaScriptObject","AbortPaymentEvent":"Event","ExtendableEvent":"Event","DedicatedWorkerGlobalScope":"EventTarget","WorkerGlobalScope":"EventTarget","JSBool":{"bool":[]},"JSNull":{"Null":[]},"JSArray":{"List":["1"],"EfficientLengthIterable":["1"],"Iterable":["1"]},"JSUnmodifiableArray":{"JSArray":["1"],"List":["1"],"EfficientLengthIterable":["1"],"Iterable":["1"]},"ArrayIterator":{"Iterator":["1"]},"JSNumber":{"double":[],"num":[]},"JSInt":{"double":[],"int":[],"num":[]},"JSNumNotInt":{"double":[],"num":[]},"JSString":{"String":[],"Pattern":[]},"_CastIterableBase":{"Iterable":["2"]},"CastIterator":{"Iterator":["2"]},"CastIterable":{"_CastIterableBase":["1","2"],"Iterable":["2"]},"_EfficientLengthCastIterable":{"CastIterable":["1","2"],"_CastIterableBase":["1","2"],"EfficientLengthIterable":["2"],"Iterable":["2"]},"CastMap":{"MapMixin":["3","4"],"Map":["3","4"],"MapMixin.K":"3","MapMixin.V":"4"},"LateError":{"Error":[]},"EfficientLengthIterable":{"Iterable":["1"]},"ListIterator":{"Iterator":["1"]},"NullError":{"TypeError":[],"Error":[]},"JsNoSuchMethodError":{"Error":[]},"UnknownJsTypeError":{"Error":[]},"_StackTrace":{"StackTrace":[]},"Closure":{"Function":[]},"Closure0Args":{"Function":[]},"Closure2Args":{"Function":[]},"TearOffClosure":{"Function":[]},"StaticClosure":{"Function":[]},"BoundClosure":{"Function":[]},"RuntimeError":{"Error":[]},"JsLinkedHashMap":{"MapMixin":["1","2"],"Map":["1","2"],"MapMixin.K":"1","MapMixin.V":"2"},"LinkedHashMapKeyIterable":{"EfficientLengthIterable":["1"],"Iterable":["1"]},"LinkedHashMapKeyIterator":{"Iterator":["1"]},"JSSyntaxRegExp":{"Pattern":[]},"NativeTypedArray":{"JavaScriptIndexingBehavior":["1"]},"NativeTypedArrayOfDouble":{"ListMixin":["double"],"JavaScriptIndexingBehavior":["double"],"List":["double"],"EfficientLengthIterable":["double"],"Iterable":["double"],"FixedLengthListMixin":["double"]},"NativeTypedArrayOfInt":{"ListMixin":["int"],"JavaScriptIndexingBehavior":["int"],"List":["int"],"EfficientLengthIterable":["int"],"Iterable":["int"],"FixedLengthListMixin":["int"]},"NativeFloat32List":{"ListMixin":["double"],"JavaScriptIndexingBehavior":["double"],"List":["double"],"EfficientLengthIterable":["double"],"Iterable":["double"],"FixedLengthListMixin":["double"],"ListMixin.E":"double"},"NativeFloat64List":{"ListMixin":["double"],"JavaScriptIndexingBehavior":["double"],"List":["double"],"EfficientLengthIterable":["double"],"Iterable":["double"],"FixedLengthListMixin":["double"],"ListMixin.E":"double"},"NativeInt16List":{"ListMixin":["int"],"JavaScriptIndexingBehavior":["int"],"List":["int"],"EfficientLengthIterable":["int"],"Iterable":["int"],"FixedLengthListMixin":["int"],"ListMixin.E":"int"},"NativeInt32List":{"ListMixin":["int"],"JavaScriptIndexingBehavior":["int"],"List":["int"],"EfficientLengthIterable":["int"],"Iterable":["int"],"FixedLengthListMixin":["int"],"ListMixin.E":"int"},"NativeInt8List":{"ListMixin":["int"],"JavaScriptIndexingBehavior":["int"],"List":["int"],"EfficientLengthIterable":["int"],"Iterable":["int"],"FixedLengthListMixin":["int"],"ListMixin.E":"int"},"NativeUint16List":{"ListMixin":["int"],"JavaScriptIndexingBehavior":["int"],"List":["int"],"EfficientLengthIterable":["int"],"Iterable":["int"],"FixedLengthListMixin":["int"],"ListMixin.E":"int"},"NativeUint32List":{"ListMixin":["int"],"JavaScriptIndexingBehavior":["int"],"List":["int"],"EfficientLengthIterable":["int"],"Iterable":["int"],"FixedLengthListMixin":["int"],"ListMixin.E":"int"},"NativeUint8ClampedList":{"ListMixin":["int"],"JavaScriptIndexingBehavior":["int"],"List":["int"],"EfficientLengthIterable":["int"],"Iterable":["int"],"FixedLengthListMixin":["int"],"ListMixin.E":"int"},"NativeUint8List":{"ListMixin":["int"],"JavaScriptIndexingBehavior":["int"],"List":["int"],"EfficientLengthIterable":["int"],"Iterable":["int"],"FixedLengthListMixin":["int"],"ListMixin.E":"int"},"_Error":{"Error":[]},"_TypeError":{"TypeError":[],"Error":[]},"_Future":{"Future":["1"]},"AsyncError":{"Error":[]},"_AsyncCompleter":{"_Completer":["1"]},"_Zone":{"Zone":[]},"_RootZone":{"_Zone":[],"Zone":[]},"MapBase":{"MapMixin":["1","2"],"Map":["1","2"]},"MapMixin":{"Map":["1","2"]},"double":{"num":[]},"int":{"num":[]},"String":{"Pattern":[]},"AssertionError":{"Error":[]},"TypeError":{"Error":[]},"NullThrownError":{"Error":[]},"ArgumentError":{"Error":[]},"RangeError":{"Error":[]},"IndexError":{"Error":[]},"UnsupportedError":{"Error":[]},"UnimplementedError":{"Error":[]},"StateError":{"Error":[]},"ConcurrentModificationError":{"Error":[]},"StackOverflowError":{"Error":[]},"CyclicInitializationError":{"Error":[]},"_StringStackTrace":{"StackTrace":[]},"MessageEvent":{"Event":[]},"MessagePort":{"EventTarget":[]},"_EventStream":{"Stream":["1"]},"DelegatingMap":{"Map":["1","2"]},"Wrapper":{"DelegatingMap":["String","@"],"Map":["String","@"],"DelegatingMap.K":"String","DelegatingMap.V":"@"},"Int8List":{"List":["int"],"EfficientLengthIterable":["int"],"Iterable":["int"]},"Uint8List":{"List":["int"],"EfficientLengthIterable":["int"],"Iterable":["int"]},"Uint8ClampedList":{"List":["int"],"EfficientLengthIterable":["int"],"Iterable":["int"]},"Int16List":{"List":["int"],"EfficientLengthIterable":["int"],"Iterable":["int"]},"Uint16List":{"List":["int"],"EfficientLengthIterable":["int"],"Iterable":["int"]},"Int32List":{"List":["int"],"EfficientLengthIterable":["int"],"Iterable":["int"]},"Uint32List":{"List":["int"],"EfficientLengthIterable":["int"],"Iterable":["int"]},"Float32List":{"List":["double"],"EfficientLengthIterable":["double"],"Iterable":["double"]},"Float64List":{"List":["double"],"EfficientLengthIterable":["double"],"Iterable":["double"]}}'));
